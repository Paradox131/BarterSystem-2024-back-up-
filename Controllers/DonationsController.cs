...
namespace BarterSystem_2024_back_up_.Controllers
{
    public class DonationsController : Controller
    {
        ...
        public DonationsController(BarterSystem_2024_back_up_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DonorName,Amount,Message,Date")] Donation donation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DonorName,Amount,Message,Date")] Donation donation)
        {
            if (id != donation.Id)
            {
                return NotFound();
